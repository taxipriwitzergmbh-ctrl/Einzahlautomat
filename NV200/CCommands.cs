...
public class CCommands
{
    ...
    public const byte SSP_POLL_COIN_MECH_DISABLED = 189;
    public const byte SSP_POLL_COIN_MECH_ENABLED = 190;
    public const byte SSP_POLL_PAYIN_BUSY = 193;
    ...
    public const byte SSP_POLL_DEVICE_FULL = 207;
