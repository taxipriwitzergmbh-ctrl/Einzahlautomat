...
namespace TaMi_Einzahlautomat.Printing
{
    public class ReceiptPrinter
    {
        ...
        private static readonly string[] KnownTypes = new[] { "SCHICHTABRECHNUNG","NACHZAHLUNG","R�CKZAHLUNG","RUECKZAHLUNG","EINZAHLUNG","AUSZAHLUNG" };
        ...
        public void PrintSimpleReceipt(string title, IEnumerable<string> bodyLines)
        {
            try
            {
                ...
                // Konfiguration f�r Legacy seriell immer setzen
                ...
                // 1) ITL Ticket Printer Versuch f�r LEGACY Namen (SSP Ticketdrucker) -> COM-Port aus Legacy1/2 Einstellungen
        ...
        private bool TryItlTicketPrint(string logicalName, string header)
        {
            try
            {
                ...
                // Ticketl�nge heuristisch aus CharsPerLine ableiten (oder Standard 90)
