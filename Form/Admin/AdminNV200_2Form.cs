...
namespace TaMi_Einzahlautomat
{
    public partial class AdminNV200_2Form : Form
    {
        ...
        private void InitializeModernAdmin()
        {
            ...
            _header = new ModernHeaderPanel { Title = "Admin - NV200/2 Steuerung" };
        ...
        protected override void OnFormClosed(FormClosedEventArgs e)
        {
            ...
            // Sendebereich entfernt -> kein AutoSend-Timer
            DetachSspEvents();
            base.OnFormClosed(e);
        }
        ...
        private void UpdateStatusUi()
        {
            try
            {
                ...
                _lblConn.Text = unlicensed ? "Unlizenziert" : (commAlive ? "Verbunden" : "Keine Aktivit�t");
                _lblConn.ForeColor = unlicensed || !commAlive ? Color.FromArgb(183, 28, 28) : Color.FromArgb(0, 128, 0);
                ...
                else if (t.Contains("disabled") || t.Contains("jammed") || t.Contains("halted") || t.Contains("failed") || t.Contains("timeout") || t.Contains("open sspcomport") || t.Contains("neustart") || t.Contains("unlizenziert"))
