...
namespace TaMi_Einzahlautomat
{
    ...
    public sealed class ProcessingAnimation : IDisposable
    {
        ...
        public static ProcessingAnimation Show(Form owner, string text = "Bitte warten �")
        {
            ...
            anim._animTimer = new System.Windows.Forms.Timer { Interval = 22 }; // ~45 FPS f�r smooth aber moderat
        ...
        private void Paint(Graphics g, Rectangle bounds, Label lbl)
        {
            ...
            int progressBaselineY = bounds.Bottom - 18; // etwas �ber unterem Rand
            ...
            float x = (_shimmerX % (bounds.Width + sweepWidth)) - sweepWidth; // kann negativ sein beim �bergang
            ...
            // Dezenter Glow �ber Baseline (leichtes Highlight unter Text � nur falls Platz)
            ...
            // Optional rechter Statusplatzhalter (kann sp�ter genutzt werden)
